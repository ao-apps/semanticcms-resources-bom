...
def upstreamProjects = [
  ...
  // BOM
  'all', // <groupId>com.semanticcms</groupId><artifactId>semanticcms-resources-all</artifactId>
  'empty', // <groupId>com.semanticcms</groupId><artifactId>semanticcms-resources-empty</artifactId>
  'filesystem', // <groupId>com.semanticcms</groupId><artifactId>semanticcms-resources-filesystem</artifactId>
  'unavailable', // <groupId>com.semanticcms</groupId><artifactId>semanticcms-resources-unavailable</artifactId>
